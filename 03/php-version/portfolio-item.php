...
<body>		
	...
	<a class="left-icon bg-blue-dark font-15" href="features-portfolios.php"><i class="fa fa-angle-left"></i></a>
			
	<div class="heading-box bg-1">
		<h3 class="ultrabold uppercase color-white center-text">Portfolio Item</h3>
		<p class="center-text color-gray">Selected Portfolio Item</p>
		<div class="overlay"></div>
	</div>

	<div class="decoration decoration-margins"></div>

	<amp-img class="full-bottom" src="images/pictures/1.jpg" width="600" height="375" layout="responsive"></amp-img>
	...
	<amp-img class="full-bottom" src="images/pictures/1w.jpg" width="600" height="210" layout="responsive"></amp-img>
