...
<body>		
	...
	<a class="left-icon bg-blue-dark font-15" href="features-pages.php"><i class="fa fa-angle-left"></i></a>
			
	<div class="heading-box bg-1">
		<h3 class="ultrabold uppercase color-white center-text">Timeline 2</h3>
		<p class="center-text color-gray">Gorgeous Timeline Design</p>
