...
<body>		
	...
	<a class="left-icon bg-blue-dark font-15" href="features-news.php"><i class="fa fa-angle-left"></i></a>
	...
	<div class="content full-bottom">
		...
		<a href="index.php" class="button uppercase ultrabold button-full center-text bg-blue-dark full-bottom">Back Home</a>
	</div>
