...
<body>		
	...
	<div class="heading-box bg-1">
		<h3 class="ultrabold uppercase color-white center-text">Testimonials</h3>
		<p class="center-text color-gray">Our Customers Love Us</p>
	...
	<div class="content">
		...
		<div class="blockquote-4">
			...
			<a href="#" class="right-text full-bottom">Alexander Stranger</a>
		</div>		
	</div>	
