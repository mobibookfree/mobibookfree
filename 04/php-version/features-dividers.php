...
<body>		
		...
		<amp-accordion class="submenu">
			<section expanded>
				...
				<div>
					...
					<a class="selected" href="features-dividers.php"><i class="fa fa-angle-right"></i>Dividiers</a>
	...
	<div class="page-content">
		...
		<div class="content material-box">
			<h4 class="uppercase ultrabold quarter-bottom">Dividers</h4>
			<p>
		...
		<div class="material-box">
			<div class="deco full-top bg-red-dark"></div>
