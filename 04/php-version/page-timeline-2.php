		...
		<amp-accordion class="submenu">
			<section expanded>
				...
				<div>
					...
					<a  class="selected"href="page-timeline-2.php"><i class="fa fa-angle-right"></i>Timeline 2</a>
	...
	<div class="page-content">
		...
		<div class="timeline-2">
				...
				<div class="container">
					...
					<a href="#" class="button button-center bg-green-dark">Button</a>
				</div>	

				<div class="timeline-icon"><i class="fa fa-bolt"></i></div>		
				<div class="container">
					<h4 class="center-text half-bottom">AMP Powered</h4>
					<amp-img class="half-bottom" src="images/pictures/1w.jpg" width="200" height="80" layout="responsive"></amp-img>
					<p class="center-text half-bottom">
				...
				<div class="container">
					<div class="blockquote-3 full-bottom">
						<amp-img class="blockquote-image" src="images/pictures/3.jpg" width="150" height="150"></amp-img>
				...
				<div class="container no-bottom">
					...
					<a href="page-timeline-2.php" class="button button-full bg-blue-dark">Check Version One</a>
				</div>
			</div>
