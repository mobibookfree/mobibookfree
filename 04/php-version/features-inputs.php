...
<body>		
		...
		<amp-accordion class="submenu">
			<section expanded>
				...
				<div>
					...
					<a class="selected" href="features-inputs.php"><i class="fa fa-angle-right"></i>Inputs</a>
	...
	<div class="page-content">
		...
		<div class="content material-box">
			<h4 class="uppercase ultrabold quarter-bottom">Inputs</h4>
			<p>
		...
		<div class="material-box">
			<p class="no-bottom">These are the current compabile elements with Google AMP. More will come in the future.</p>
		</div>
		...
		<div class="material-box full-bottom">
			...
			<div class="select-style half-bottom">
				<select>
