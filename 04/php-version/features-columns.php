...
<body>		
		...
		<amp-accordion class="submenu">
			<section expanded>
				...
				<div>
					...
					<a class="selected" href="features-columns.php"><i class="fa fa-angle-right"></i>Columns</a>
	...
	<div class="page-content">
		...
		<div class="content material-box">
			<h4 class="uppercase ultrabold quarter-bottom">Columns</h4>
			<p>
		...
		<div class="material-box">
			<div>
				...
				<amp-img class="half-bottom" src="images/pictures/1w.jpg" layout="responsive" width="300" height="110"></amp-img>
				<p>
			...
			<div class="left-column">
				...
				<amp-img class="half-bottom" src="images/pictures/2w.jpg" layout="responsive" width="300" height="110"></amp-img>
				<p>
					Praesent eget massa tristique, viverra nulla in, euismod lacus. Phasellus vitae urna quis arcu iaculis posuere
				</p>
			</div>
			<div class="right-column">
				...
				<amp-img class="half-bottom" src="images/pictures/3w.jpg" layout="responsive" width="300" height="110"></amp-img>
				<p>
					Praesent eget massa tristique, viverra nulla in, euismod lacus. Phasellus vitae urna quis arcu iaculis posuere
				</p>
			</div>
