...
<body>		
	...
	<amp-sidebar id="sidebar" layout="nodisplay" side="left">
		...
		<amp-accordion class="submenu">
			<section expanded>
				...
				<div>
					<a class="selected" href="amp-accordion.php"><i class="fa fa-angle-right"></i>Accordion</a>
					<a href="amp-carousel.php"><i class="fa fa-angle-right"></i>Carousel</a>
	...
	<div class="page-content">
		...
		<div class="content material-box">
			<h4 class="uppercase ultrabold quarter-bottom">AMP Accordion</h4>
			<p>
					...
					<amp-accordion class="nested-accordion">
						<section>
							...
							<p>
								...
								<amp-img src="images/pictures/1w.jpg" width="300" height="120" class="full-top" layout="responsive"></amp-img>	
							</p>
						</section>
						<section>
