...
<body>		
	...
	<amp-sidebar id="sidebar" layout="nodisplay" side="left">
		...
		<amp-accordion class="submenu">
			<section expanded>
				...
				<div>
					<a class="selected" href="index-news.php"><i class="fa fa-angle-right"></i>News Home</a>
	...
	<div class="news-slider">
		<amp-carousel class="slider" width="600" height="450" layout="responsive" type="slides" autoplay loop delay="3000">
			<a href="#">
	...
	<div class="page-content-before">
	<div class="page-content">

		<div class="material-box">
			<div class="news-thumbs no-bottom">
		...
		<div class="material-box">
			...
			<div class="full-bottom">
				...
				<a href="#" class="button button-full center-text bg-green-dark no-bottom">More in Mobile</a>
			</div>
		</div>
		...
		<div class="material-box">
			...
			<div class="full-bottom"></div>
				...
				<a href="#" class="button button-full center-text bg-red-dark no-bottom">More in Envato</a>
			</div>	
