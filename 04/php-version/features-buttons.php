...
<body>		
	...
	<amp-sidebar id="sidebar" layout="nodisplay" side="left">
		...
		<amp-accordion class="submenu">
			<section expanded>
				...
				<div>
					<a class="selected" href="features-buttons.php"><i class="fa fa-angle-right"></i>Buttons</a>
	...
	<div class="page-content">
		...
		<div class="content material-box">
			<h4 class="uppercase ultrabold quarter-bottom">Buttons</h4>
			<p>
		...
		<div class="material-box">
			<h3 class="ultrabold uppercase quarter-bottom">Classic Buttons</h3>
			<p class="no-bottom">
				Simple, easy to use, copy and paste features for your mobile AMP Website. 
			</p>
		</div>
		...
		<div class="material-box">
			<h3 class="ultrabold uppercase quarter-bottom">3D Buttons</h3>
			<p class="no-bottom">
				Simple, easy to use, copy and paste features for your mobile AMP Website. 
			</p>
		</div>
		...
		<div class="material-box">
			<h3 class="ultrabold uppercase quarter-bottom">Round Buttons</h3>
			<p class="no-bottom">
				Simple, easy to use, copy and paste features for your mobile AMP Website. 
			</p>
		</div>
		...
		<div class="material-box">
			<h3 class="ultrabold uppercase quarter-bottom">Fullscreen Buttons</h3>
			<p class="no-bottom">
				Simple, easy to use, copy and paste features for your mobile AMP Website. 
			</p>
		</div>
		...
		<div class="material-box">
			<h3 class="ultrabold uppercase quarter-bottom">Icons</h3>
			<p class="no-bottom">
				Simple, easy to use, copy and paste features for your mobile AMP Website. 
			</p>
		</div>
