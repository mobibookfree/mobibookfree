...
<body>		
	...
	<amp-sidebar id="sidebar" layout="nodisplay" side="left">
		...
		<amp-accordion class="submenu">
			<section expanded>
				...
				<div>
					<a class="selected" href="portfolio-1.php"><i class="fa fa-angle-right"></i>One Column</a>
	...
	<div class="page-content">
		...
		<div class="content material-box">
			<h4 class="uppercase ultrabold quarter-bottom">Portfolio 1 Column</h4>
			<p>
		...
		<div class="material-box">
			<div class="portfolio-item">
				...
				<h3 class="half-top half-bottom">Project Title</h3>
				<p>
				...
				<a href="#" class="right-text no-bottom">Read More</a>
			</div>
		</div>
