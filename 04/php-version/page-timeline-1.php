		...
		<amp-accordion class="submenu">
			<section expanded>
				...
				<div>
					...
					<a  class="selected" href="page-timeline-1.php"><i class="fa fa-angle-right"></i>Timeline 1</a>
	...
	<div class="page-content">
		...
		<div class="timeline-1">
			...
			<div class="container">
				...
				<a href="page-timeline-2.php" class="button button-full bg-blue-dark">Check Version Two</a>
			</div>
		</div>
