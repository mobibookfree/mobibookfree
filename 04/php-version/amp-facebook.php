...
<body>		
	...
	<amp-sidebar id="sidebar" layout="nodisplay" side="left">
		...
		<amp-accordion class="submenu">
			<section expanded>
				...
				<div>
					<a class="selected" href="amp-facebook.php"><i class="fa fa-angle-right"></i>Facebook</a>
	...
	<div class="page-content">
		<div class="content material-box">
			<h4 class="uppercase ultrabold quarter-bottom">AMP Facebook</h4>
			<p>
		...
		<amp-facebook class="half-bottom" width="220" height="303" layout="responsive" data-href="https://www.facebook.com/enabled.labs/posts/1395483060466743"></amp-facebook>
