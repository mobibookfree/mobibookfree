...
<body>		
		...
		<amp-accordion class="submenu">
			<section expanded>
				...
				<div>
					...
					<a class="selected" href="portfolio-2.php"><i class="fa fa-angle-right"></i>Two Columns</a>
	...
	<div class="page-content">
		...
		<div class="content material-box">
			<h4 class="uppercase ultrabold quarter-bottom">Portfolio 2 Columns</h4>
			<p>
		...
		<div class="material-box">
			<div class="left-column">
				<div class="portfolio-item">
					<amp-img src="images/pictures/5.jpg" layout="responsive" width="600" height="375"></amp-img>
					<h4 class="half-top">Project Title</h4>
					<p class="small-text">
