...
<body>		
	...
	<amp-sidebar id="sidebar" layout="nodisplay" side="left">
		...
		<amp-accordion class="submenu">
			<section expanded>
				<h4 class="selected"><i class="fa fa-bolt"></i>AMP Media</h4>
				<div>
					...
					<a class="selected" href="amp-lightbox.php"><i class="fa fa-angle-right"></i>LightBox</a>
	...
	<div class="heading-box bg-1 page-title">
		<h3 class="ultrabold uppercase color-white center-text">Lightbox</h3>
		<p class="center-text color-gray">Defaut Features powered by Google</p>
	...
	<div class="page-content">
		...
		<figure class="full-bottom">
			<amp-img on="tap:lightbox1" role="button" tabindex="0" layout="responsive" src="images/pictures/4.jpg" width="300" height="200"></amp-img>
