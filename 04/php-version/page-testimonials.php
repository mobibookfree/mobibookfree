...
<body>		
		...
		<amp-accordion class="submenu">
			<section expanded>
				...
				<div>
					...
					<a  class="selected"href="page-testimonials.php"><i class="fa fa-angle-right"></i>Testimonials</a>
	...
	<div class="page-content">
		...
		<div class="content material-box">
			<h4 class="uppercase ultrabold quarter-bottom">Testimonials</h4>
			<p>
		...
		<div class="material-box">
			<div class="blockquote-2 full-top-bottom">
				...
				<a href="#" class="full-bottom">Awesome Buyer | ThemeForest</a>
			</div>
		</div>
		...
		<div class="material-box">
			<div class="blockquote-3 full-bottom">
				...
				<a href="#" class="center-text">Awesome Buyer | ThemeForest</a>
			</div>
		</div>
		...
		<div class="material-box">
			<div class="blockquote-4">
				...
				<a href="#" class="right-text no-bottom">Alexander Stranger</a>
			</div>		
		</div>	
