...
<body>		
		...
		<amp-accordion class="submenu">
			<section expanded>
				...
				<div>
					...
					<a class="selected"href="amp-soundcloud.php"><i class="fa fa-angle-right"></i>SoundCloud</a>
	...
	<div class="page-content">
		...
		<div class="content material-box">
			<h4 class="uppercase ultrabold quarter-bottom">AMP SoundCloud</h4>
			<p>
		...
		<div class="material-box">
			<p class="no-bottom">
				Embed simple audio elements from SoundCloud and enjoy them with great ease.
			</p>
		</div>
		...
		<div class="material-box">
			<p class="no-bottom">
				Embed simple audio elements with a stunning visual effect from Sound Cloud.
			</p>
		</div>
