...
<body>		
		...
		<amp-accordion class="submenu">
			<section expanded>
				...
				<div>
					...
					<a class="selected" href="amp-instagram.php"><i class="fa fa-angle-right"></i>Instagram</a>
	...
	<div class="page-content">
		<div class="content material-box">
			<h4 class="uppercase ultrabold quarter-bottom">AMP Instagram</h4>
			<p>
		...
		<div class="material-box">
			<amp-instagram class="no-bottom" data-shortcode="6oPeMaHXxg" width="1" height="1" layout="responsive"></amp-instagram>
		</div>

		<div class="material-box">
			<amp-instagram class="no-bottom" data-shortcode="6oL9ePnX7w" width="1" height="1" layout="responsive"></amp-instagram>
		</div>
