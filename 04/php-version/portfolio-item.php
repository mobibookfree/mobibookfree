...
<body>		
	...
	<amp-sidebar id="sidebar" layout="nodisplay" side="left">
		...
		<amp-accordion class="submenu">
			<section expanded>
				<h4 class="selected"><i class="fa fa-image"></i>Portfolio</h4>
				<div>
					...
					<a class="selected" href="portfolio-item.php"><i class="fa fa-angle-right"></i>Selected Item</a>
				</div>
			</section>
		</amp-accordion>
		<amp-accordion class="submenu">
	...
	<div class="page-content">
		...
		<div class="content material-box">
			<h4 class="uppercase ultrabold quarter-bottom">Portfolio Item</h4>
			<p>
