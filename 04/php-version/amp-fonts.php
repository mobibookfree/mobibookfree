...
<body>		
		...
		<amp-accordion class="submenu">
			<section expanded>
				...
				<div>
					...
					<a href="amp-carousel.php"><i class="fa fa-angle-right"></i>Carousel</a>
					<a class="selected" href="amp-fonts.php"><i class="fa fa-angle-right"></i>Fonts</a>
	...
	<div class="heading-box bg-1 page-title">
		<h3 class="ultrabold uppercase color-white center-text">Google & Font Awesome</h3>
	...
	<div class="page-content">
		...
		<div class="material-box">
			<h4 class="ultrabold uppercase quarter-bottom">Fonts in AMP are simple</h4>
			<p class="no-bottom">
		...
		<div class="material-box demo-icons">
