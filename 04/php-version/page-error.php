...
<body>		
	...
	<amp-sidebar id="sidebar" layout="nodisplay" side="left">
		...
		<amp-accordion class="submenu">
			<section expanded>
				...
				<div>
					<a class="selected" href="page-error.php"><i class="fa fa-angle-right"></i>Error</a>
	...
	<div class="page-content">
		...
		<div class="page-404 material-box full-bottom">
			...
			<a href="#" class="button button-center bold bg-green-dark">HOME</a>
		</div>
