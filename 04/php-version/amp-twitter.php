...
<body>		
	...
	<amp-sidebar id="sidebar" layout="nodisplay" side="left">
		...
		<amp-accordion class="submenu">
			<section expanded>
				<h4 class="selected"><i class="fa fa-bolt"></i>AMP Social</h4>
				<div>
					...
					<a class="selected" href="amp-twitter.php"><i class="fa fa-angle-right"></i>Twitter</a>
	...
	<div class="page-content">
		...
		<div class="content material-box">
			<h4 class="uppercase ultrabold quarter-bottom">AMP Daily</h4>
			<p>
		...
		<amp-twitter class="no-bottom" width="390" height="330" layout="responsive" data-tweetid="782938357659799552" data-cards="hidden"></amp-twitter>
		</div>

		<div class="material-box">
			<amp-twitter class="no-bottom" width="390" height="330" layout="responsive" data-tweetid="782938357659799552"></amp-twitter>	
		</div>
