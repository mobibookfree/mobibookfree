...
<body>		
		...
		<amp-accordion class="submenu">
			<section expanded>
				...
				<div>
					...
					<a class="selected" href="page-profile-2.php"><i class="fa fa-angle-right"></i>Profile 2</a>
	...
	<div class="page-content">
		...
		<div class="page-profile material-box">
			...
			<div class="content full-bottom">
				<a href="#" class="button button-center button-round bg-pink-dark uppercase ultrabold">Follow Karla</a>
			</div>
