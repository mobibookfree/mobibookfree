...
<body>		
		...
		<amp-accordion class="submenu">
			<section expanded>
				...
				<div>
					...
					<a class="selected" href="features-headings.php"><i class="fa fa-angle-right"></i>Headings</a>
	...
	<div class="page-content">
		<div class="content material-box">
			<h4 class="uppercase ultrabold quarter-bottom">Page Headings</h4>
			<p>
	...
	<div class="page-content-full">
			...
			<div class="heading-box bg-1">
				<h3 class="ultrabold uppercase color-white center-text">Headings</h3>
				<p class="center-text color-gray">Awesome Headings</p>
				<div class="overlay"></div>
			</div>
			
			<div class="decoration decoration-margins"></div>

			<div class="heading-block bg-5">
				<h4>Headings</h4>
				<p>This is a heading too!</p>
				<div class="overlay"></div>
			</div>
			<div class="decoration decoration-margins"></div>
