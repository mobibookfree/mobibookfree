...
<body>		
	...
	<amp-sidebar id="sidebar" layout="nodisplay" side="left">
		...
		<amp-accordion class="submenu">
			<section expanded>
				<h4 class="selected"><i class="fa fa-camera"></i>Gallery</h4>
				<div>
					<a class="selected" href="gallery-round.php"><i class="fa fa-angle-right"></i>Round</a>
	...
	<div class="heading-box bg-1 page-title">
		<h3 class="ultrabold uppercase color-white center-text">Gallery Round</h3>
	...
	<div class="page-content">
		...
		<div class="material-box">
			...
			<div class="gallery gallery-round no-bottom">
