...
<body>		
		...
		<amp-accordion class="submenu">
			<section expanded>
				...
				<div>
					...
					<a class="selected" href="news-cards.php"><i class="fa fa-angle-right"></i>News Cards</a>
	...
	<div class="page-content">
		...
		<div class="news-full">
			<div class="news-item">
				<amp-img src="images/pictures/3.jpg" width="600" height="350" layout="responsive"></amp-img>
				<div class="titles">
					<h5 class="thiner">Apple renames to Strawberry</h5>
					<em><a href="#">Mobile News</a> about <a href="#">45 minutes</a> ago</em>
				</div>
				<div class="material-box material-news">
					<p>
						Donec eget mauris sit amet metus sollicitudin varius. Fusce et finibus orci, 
						in congue neque. Etiam vitae tortor vitae lacus feugiat pretium at at turpis. 
						Maecenas tincidunt egestas sapien, pharetra gravida.
					</p>
					<a href="#" class="read-more">Continue Reading</a>
				</div>
			</div>
			<div class="news-item">
				<amp-img src="images/pictures/2.jpg" width="600" height="375" layout="responsive"></amp-img>
				<div class="titles">
					<h5 class="thiner">Android uses flower names for OS</h5>
					<em><a href="#">Mobile News</a> about <a href="#">45 minutes</a> ago</em>
				</div>
				<div class="material-box material-news">
					<p>
			...
			<div class="news-item">
				<amp-img src="images/pictures/3.jpg" width="600" height="375" layout="responsive"></amp-img>
				<div class="titles">
					<h5 class="thiner">Windows now makes Pancake</h5>
					<em><a href="#">Mobile News</a> about <a href="#">45 minutes</a> ago</em>
				</div>
				<div class="material-box material-news">
					<p>
			...
			<div class="news-item">
				<amp-img src="images/pictures/4.jpg" width="600" height="375" layout="responsive"></amp-img>
				<div class="titles">
					<h5 class="thiner">New app is actually a typewriter</h5>
					<em><a href="#">Mobile News</a> about <a href="#">45 minutes</a> ago</em>
				</div>
				<div class="material-box material-news">
					<p>
		...
		<div class="news-strip">
			...
			<amp-img src="images/pictures/1.jpg" layout="responsive" width="300" height="200"></amp-img>
			<div class="content">
