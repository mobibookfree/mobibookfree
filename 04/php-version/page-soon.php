...
<body>		
		...
		<amp-accordion class="submenu">
			<section expanded>
				...
				<div>
					...
					<a class="selected" href="page-soon.php"><i class="fa fa-angle-right"></i>Soon</a>
	...
	<div class="page-content">
		...
		<div class="page-soon material-box full-bottom">
			<h1 class="center-text ultrabold half-bottom"><i class="fa fa-spin fa-cog"></i></h1>
