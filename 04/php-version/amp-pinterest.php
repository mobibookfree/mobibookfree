...
<body>		
		...
		<amp-accordion class="submenu">
			<section expanded>
				...
				<div>
					...
					<a class="selected" href="amp-pinterest.php"><i class="fa fa-angle-right"></i>Pinterest</a>
	...
	<div class="page-content">
		...
		<div class="content material-box">
			<h4 class="uppercase ultrabold quarter-bottom">AMP Pinterest</h4>
			<p>
		...
		<amp-pinterest class="full-bottom" width=210 height=185 layout="responsive" data-do="embedPin" data-url="https://www.pinterest.com/pin/427208714637069788/"></amp-pinterest>
