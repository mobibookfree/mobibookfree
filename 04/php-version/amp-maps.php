...
<body>		
		...
		<amp-accordion class="submenu">
			<section expanded>
				...
				<div>
					...
					<a class="selected" href="amp-maps.php"><i class="fa fa-angle-right"></i>Maps</a>
	...
	<div class="heading-box bg-1 page-title">
		<h3 class="ultrabold uppercase color-white center-text">Google MAPS</h3>
	...
	<div class="page-content">
		...
		<div class="content material-box">
			<h4 class="uppercase ultrabold quarter-bottom">AMP Maps</h4>
			<p>
		...
		<div class="material-box">
			<h4 class="uppercase ultrabold quarter-bottom">Using maps with AMP</h4>
			<p class="no-bottom">
